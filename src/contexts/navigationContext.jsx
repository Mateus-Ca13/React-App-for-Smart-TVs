...
const NavigationContextProvider = ({children})=>{
    ...
    const [focusedElement, setFocusedElement] = useState(null) // Objeto do elemento Selectable que está em foco.
    ...
    return <navigationContext.Provider value={{
        ...
        selectablesList, setSelectablesList,
        keyHandler, setKeyHandler,
